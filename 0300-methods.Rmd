...
realted to disconnections due to the railway documented in `bcfishpass` [@norris2024bcfishpass] [here](https://github.com/smnorris/bcfishpass/tree/main/model/03_habitat_lateral).  
