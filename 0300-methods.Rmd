...
[Here](https://github.com/NewGraphEnvironment/restoration_wedzin_kwa_2024/blob/main/LICENSE) is an example of
...
### Tables and Figures
There are many tables within this document that can take have a long time to format.  Within this document the tables have been imported often as simple csv files or pages of an excel workbook and pulled into the project using scripts. This allows others to access the data and use it in their own projects.  These tables can also then be easily updated
