...
```{r, eval=TRUE}
caption_08EE003 <- fpr_create_hydrograph_local("08EE003", start_year = "1980")
```

```{r pane-hydat-08EE003, fig.cap = caption_08EE003, eval=TRUE}
knitr::include_graphics("fig/hydrology_stats_08EE003.png")
```


```{r, eval=TRUE}
caption_08EE004<- fpr_create_hydrograph_local("08EE004")
```

```{r pane-hydat-08EE004, fig.cap = caption_08EE004, eval=TRUE}
...
```{r, eval=TRUE}
caption_08ED002<- fpr_create_hydrograph_local("08ED002")
```

```{r pane-hydat-08ED002, fig.cap = caption_08ED002, eval=TRUE}
